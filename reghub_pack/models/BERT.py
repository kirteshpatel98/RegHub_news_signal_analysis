...
class BERT_RegHub(BertClassifier):
    ...
    def pre_load(self, train_data=None, val_data=None, batch_size=32,Dataset=Dataset,DataLoader=DataLoader):
        
        self.batch_size=batch_size
        self.train_data=train_data
        self.val_data=val_data
        # initialize parent class Dataset
        self.train=Dataset(self.train_data)
        self.val=Dataset(self.val_data)
    ...
    def classifier(self,F=F,torch=torch,input_text="Commerzbank faced bankrupcy today",table_format=False,df_test=None,Dataset=Dataset,pd=pd,custom_model=None):
